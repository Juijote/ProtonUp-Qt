...
class CtInstaller(QObject):
    ...
    BUFFER_SIZE = 4096
    CT_URL = 'https://steamdeck-proxy.juij.eu.org/https://api.github.com/repos/dreamer/boxtron/releases'
    CT_INFO_URL = 'https://steamdeck-proxy.juij.eu.org/https://github.com/dreamer/boxtron/releases/tag/'
