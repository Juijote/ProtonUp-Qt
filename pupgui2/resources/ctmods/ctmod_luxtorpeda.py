...
class CtInstaller(QObject):
    ...
    BUFFER_SIZE = 65536
    CT_URL = 'https://steamdeck-proxy.juij.eu.org/https://api.github.com/repos/luxtorpeda-dev/luxtorpeda/releases'
    CT_INFO_URL = 'https://steamdeck-proxy.juij.eu.org/https://github.com/luxtorpeda-dev/luxtorpeda/releases/tag/'
