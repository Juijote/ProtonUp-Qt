...
class CtInstaller(DXVKInstaller):
    ...
    CT_URL = 'https://steamdeck-proxy.juij.eu.org/https://api.github.com/repos/Sporif/dxvk-async/releases'
    CT_INFO_URL = 'https://steamdeck-proxy.juij.eu.org/https://github.com/Sporif/dxvk-async/releases/tag/'
