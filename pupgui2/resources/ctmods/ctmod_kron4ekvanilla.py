...
class CtInstaller(QObject):
    ...
    BUFFER_SIZE = 65536
    CT_URL = 'https://steamdeck-proxy.juij.eu.org/https://api.github.com/repos/Kron4ek/Wine-Builds/releases'
    CT_INFO_URL = 'https://steamdeck-proxy.juij.eu.org/https://github.com/Kron4ek/Wine-Builds/releases/tag/'
